...
- Отвязанные от FPS рендера анимациии. Используются оригинальные векторные кадры из игры, что дает возможность динамически менять контент в них — у персонажа убирать лишние лапы, менять шапки и артефакты.
