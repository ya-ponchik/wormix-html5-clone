...
- Базука. Завима от силы и направления ветра. Снаряд вылетает точно из ствола. При взрыве рушит землю и подбрасывает сущности вблизи. Звук при взаимодействии с окружением.
- Визуальное отображения оружия в руках.
